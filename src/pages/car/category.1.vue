  ...
  <div style="height: 100%;" class="container">
          ...
          <div class="weui-search-bar">
            <div class="weui-search-bar__form">
              <div class="weui-search-bar__box">
                ...
                <input type="text" class="weui-search-bar__input" placeholder="搜一搜" v-model="inputVal" :focus="inputShowed" @input="inputTyping" />
    ...
    <div class="width100 goodsWrap weui-flex">
      <scroll-view style="position: relative;" class="left_menu_scroll" scroll-with-animation="true" scroll-y :scroll-into-view="navId">
        <ul>
          <li class="left_menu_item" :id="'nav_'+index" v-for="(menu, index) in menus" :key="index" :class="index===currentIndex ? 'current' : ''" @click="selectMenu(index, $event)">
            <p class="text">{{menu.categoryName}}</p>
          </li>
        </ul>
      </scroll-view>
      <scroll-view style="position: relative;" class="right_menu_scroll" scroll-y :scroll-into-view="contentId" @scroll="onScroll" scroll-with-animation="true">
        <ul>
